...
interface ShadowbanLogDateFiltersProps {
  startDate: string;
  endDate: string;
...
const ShadowbanLogDateFilters = memo(function ShadowbanLogFilters({
  startDate,
  endDate,
  onStartDateChange,
  onEndDateChange,
...
export default ShadowbanLogDateFilters;
